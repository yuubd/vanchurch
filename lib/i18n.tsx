...
const strings = {
  ko: {
    ...
    back: '뒤로',
    error: '오류',
    onboardingSubtitle: '공동체를 만들거나\n기존 공동체에 참여하세요',
    createCommunityCard: '공동체 만들기',
    createCommunityCardSub: '관리자 권한이 부여돼요',
    findCommunityCard: '공동체 참여하기',
    findCommunityCardSub: '기존 공동체를 검색해요',
    findCommunityTitle: '공동체 찾기',
    findCommunitySubtitle: '참여할 공동체를 검색하세요',
    requestSentTo: '%에 참여 요청을 보냈어요',
    searchCommunityPlaceholder: '공동체 이름 검색...',
    noSearchResults: '검색 결과가 없습니다',
    createCommunityDirectly: '+ 공동체 직접 만들기',
    requestToJoin: '참여 요청',
    createCommunityTitle: '공동체 만들기',
    createCommunitySubtitle: '새로운 공동체를 시작하세요\n관리자 권한이 부여됩니다',
    communityNameLabel: '공동체 이름 *',
    communityNamePlaceholder: 'VKPC 밴쿠버 한인 장로교회',
    publicCommunity: '공개 공동체',
    publicCommunitySub: '검색으로 찾을 수 있어요',
    createBtn: '만들기',
    ...
    devDashboard: '개발자 대시보드',
    devChurches: '공동체',
    devUsers: '전체 사용자',
    devSignups7d: '7일 신규 가입',
    devPrayers: '기도제목',
    devPrayers7d: '7일 기도제목',
    devCells: '셀',
    devNoChurch: '공동체 미소속',
    devChurchBreakdown: '공동체별 현황',
    devFeedback: '전체 피드백',
    devPublic: '공개',
    devCreated: '생성',
    devLastPrayer: '최근 기도제목',
    devMembersShort: '멤버',
    devCellsShort: '셀',
    devPrayersShort: '기도',
    devPendingShort: '대기',
  ...
  en: {
    ...
    back: 'Back',
    error: 'Error',
    onboardingSubtitle: 'Create a community or\njoin an existing one',
    createCommunityCard: 'Create a community',
    createCommunityCardSub: "You'll become the admin",
    findCommunityCard: 'Find & join a community',
    findCommunityCardSub: 'Search for an existing community',
    findCommunityTitle: 'Find a community',
    findCommunitySubtitle: 'Search for a community to join',
    requestSentTo: "You've requested to join %",
    searchCommunityPlaceholder: 'Search community name...',
    noSearchResults: 'No results found',
    createCommunityDirectly: '+ Create a community directly',
    requestToJoin: 'Request to join',
    createCommunityTitle: 'Create a community',
    createCommunitySubtitle: "Start a new community\nyou'll be granted admin rights",
    communityNameLabel: 'Community name *',
    communityNamePlaceholder: 'Grace Community Church',
    publicCommunity: 'Public community',
    publicCommunitySub: 'Discoverable via search',
    createBtn: 'Create',
    ...
    devChurches: 'Communities',
    devUsers: 'Total users',
    devSignups7d: 'Signups (7d)',
    devPrayers: 'Prayer requests',
    devPrayers7d: 'Prayers (7d)',
    devCells: 'Cells',
    devNoChurch: 'No community',
    devChurchBreakdown: 'By community',
    devFeedback: 'All feedback',
    devPublic: 'Public',
    devCreated: 'Created',
    devLastPrayer: 'Last prayer',
    devMembersShort: 'Members',
    devCellsShort: 'Cells',
